...
--
-- Host: 127.0.0.1
-- Generation Time: 19 Okt 2017 pada 18.52
-- Versi Server: 5.6.21
-- PHP Version: 5.6.3
...
(5, '153060021493', 4449, 'LA44', 'Capacity Building', 'Lembaga', '2017-10-04', '2017-10-20', 99, '-', '747095.jpg', NULL);
...
('153060021192', 'Anjasmara', 'Akuntansi', '0000-00-00', 4),
...
--
ALTER TABLE `kegiatan`
ADD CONSTRAINT `kegiatan_ibfk_1` FOREIGN KEY (`npm`) REFERENCES `mahasiswa` (`npm`);
